...
def main():
    ...
    comp, c1, c2, n = next_review(project_id, reviewer)
    assert comp['id'] == cid
    ...
    comp, _, _, next_n = next_review(project_id, reviewer)
    ...
    test, _, _, next_n = next_review(project_id, reviewer)
    ...
    comp, _, _, n = next_review(project_id, reviewer)
    comp, _, _, next_n = next_review(project_id, reviewer)
