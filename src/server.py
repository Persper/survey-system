...
@app.route('/v1')
def version():
    return 'The Persper Survey System v1'


@app.route('/v1/projects/<project_id>/questions/next', methods=["GET"])
...
@app.route('/v1/projects/<project_id>/questions/<question_id>', methods=["POST"])
...
@app.route('/v1/projects/<project_id>/reviews/next', methods=["GET"])
...
@app.route('/v1/projects/<project_id>/reviews/<review_id>', methods=["POST"])
...
@app.route('/v1/projects/<project_id>/labels/new', methods=["POST"])
...
@app.route('/v1/projects/<project_id>/labels', methods=["GET"])
